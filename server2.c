...
void list(int sockfd)
{
  	...
  	if (getcwd(cwd, sizeof(cwd)) != NULL) 
	{
   		...
   		DIR *dr = opendir(cwd); 
    		...
    		if (dr == NULL)  /* opendir returns NULL if could not open directory */ 
    		{ 
...
int main() 
{
	...
	int sockfd, connfd, len; /* Creates socket file descriptor */ 
 	struct sockaddr_in servaddr, cli; /* Creates structure object of sockaddr_in for client and server */ /* Socket creation and verification */ 
